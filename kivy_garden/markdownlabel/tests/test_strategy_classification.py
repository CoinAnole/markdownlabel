...
class TestMaxExamplesCalculation:
    ...
    def test_complex_strategy_uses_complexity_based_examples(self, complexity_level):
        ...
        **Validates: Requirements 1.5, 2.3**
        ...
        from kivy_garden.markdownlabel.tests.modules.strategy_analyzer import StrategyAnalysis, StrategyType
...
class TestCombinationStrategies:
    ...
    def test_combination_with_strategy_variables(self):
        ...
        from kivy_garden.markdownlabel.tests.modules.strategy_analyzer import StrategyClassifier, StrategyType
