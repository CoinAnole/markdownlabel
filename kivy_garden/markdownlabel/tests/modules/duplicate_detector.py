...
from .file_parser import FileParser, HelperFunction
...
def main():
    ...
    print("Analyzing test files in {}...".format(directory))
    report = detector.analyze_directory(directory)

    print("\nDuplicate Detection Report:")
    print("Total duplicate groups: {}".format(len(report.duplicate_groups)))
    print("Total duplicate functions: {}".format(report.total_duplicates))
    print("Files affected: {}".format(report.total_files_affected))
    print("Estimated consolidation savings: {} lines".format(report.consolidation_savings))
