...
class TestCustomValueDocumentation:
    ...
    # *For any* property-based test using custom max_examples values (not in standard set {2, 5, 10, 20, 50, 100}), 
...
class TestMachineReadableFormat:
    ...
    # *For any* standardized comment, automated parsing tools SHALL be able to extract 
