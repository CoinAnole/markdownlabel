...
class TestCommentFormatValidation:
    ...
    # Small finite strategy: 5 examples (input space size: 6)
...
class TestCustomValueDocumentation:
    ...
    # Mixed finite/complex strategy: 25 examples (adequate coverage)
...
class TestMachineReadableFormat:
    ...
    # Mixed finite/complex strategy: 30 examples (performance optimized)
