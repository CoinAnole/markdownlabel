...
'''
            ...
            assert after_report.total_duplicates < before_report.total_duplicates, \
                f"Consolidation should reduce duplicates: {before_report.total_duplicates} -> {after_report.total_duplicates}"
            
            assert len(after_report.duplicate_groups) <= len(before_report.duplicate_groups), \
                f"Consolidation should reduce duplicate groups: {len(before_report.duplicate_groups)} -> {len(after_report.duplicate_groups)}"
